data merge entity @s {CustomNameVisible:0b,PersistenceRequired:1b,Tags:["tsurv.jockey","global.ignore","tsurv.trader","smithed.entity","tsurv.nomad"],CustomName:'{"fallback":"Jockey","translate":"test"}',active_effects:[{id:"minecraft:fire_resistance",amplifier:0,duration:36000,show_particles:0b}]}
