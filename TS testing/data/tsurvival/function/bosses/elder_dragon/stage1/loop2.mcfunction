...
execute if score $tsurv.gerrupting tsurv.edragon.loop2 matches 2.. at @e[tag=tsurv.gerrupting] run particle minecraft:end_rod ~ ~3 ~ 0.01 4.5 0.01 0.04 18
execute if score $tsurv.gerrupting tsurv.edragon.loop2 matches 2.. at @e[tag=tsurv.gerrupting] positioned ~-0.85 ~ ~-0.85 run effect give @a[dx=0.7,dy=9,dz=0.7] minecraft:levitation 1 15 true
